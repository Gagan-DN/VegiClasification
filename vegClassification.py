...
#To keep Data constant
np.random.seed(42)

from sklearn.model_selection import train_test_split
from sklearn.metrics import confusion_matrix
import itertools
#The itertools module is a versatile and efficient tool for working with iterators in Python. 
#Its ability to create complex iterators from simple building blocks makes it a valuable resource 
#for developers looking to optimize their code and handle data more effectively."""
...
trainpath = '../dataset/Vegetable Images/train'
testpath = '../dataset/Vegetable Images/traintest'
valpath = '../dataset/Vegetable Images/validation'
...
print(count_files(trainpath))
print(count_files(testpath))
print(count_files(testpath))
